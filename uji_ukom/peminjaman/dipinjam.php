...
session_start();
	...
	$sql_dipinjam = mysql_query("SELECT * FROM peminjaman INNER JOIN pengguna on peminjaman.id_pengguna = pengguna.id_pengguna INNER JOIN barang on peminjaman.id_barang = barang.id_barang WHERE peminjaman.status=1");
...
<div class="container">
		...
		<b style="font-size: 12px;">Daftar Peminjaman Dipinjam
		</b>		
	</div>
